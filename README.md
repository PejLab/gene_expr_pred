...
This script is designed to predict allele-specific expression and total gene expression using allelic fold change (aFC). See the [manuscript](https://genome.cshlp.org/content/27/11/1872.short) for method description.
...
The assumption is that the build version is aligned to the GRCh38 assembly (variant id followed by _b38).
